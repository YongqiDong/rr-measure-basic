# downloaded from https://developer.ieee.org/Python3_Software_Development_Kit
# documentation availible at https://developer.ieee.org/Python3_Software_Development_Kit
import math
