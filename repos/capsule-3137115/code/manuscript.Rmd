...
```{r forestPlot, fig.cap="Forest plot showing the proportion of articles with fully reproducible target values in Hardwicke et al. (2018) and the present study before and after contacting original authors for assistance with reproducibility checks. Squares represent individual study proportions. Diamonds represent summary proportions estimated by random effects (RE) models. Error bars represent 95% confidence intervals (CIs).", fig.width=8}
source(here('meta_analysis.R'))
```
...
source(here('plot_reproScatter.R')) # build plot
...
```{r valueTypePlot, fig.cap="Frequency of reproducibility outcomes by value type. Variation/uncertainty measures include standard deviations, standard errors, and confidence intervals. Effect sizes include Cohen's d, Pearson's r, partial eta squared, and phi. Test statistics include t, F, and chi squared. Central tendency measures include means and medians."}
source(here('plot_valueType.R')) # build plot
