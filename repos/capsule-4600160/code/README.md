...
``` 
# Citation
Geller, J., Winn, M., Mahr, T., Mirman, D. (in press ). GazeR:A package to analyze gaze position and pupil size data. Behavioral Research Methods.  
