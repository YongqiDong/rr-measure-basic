...
pdf('results/GC-diagnosis-model/Figures/Model-performance/PCA_Test.pdf',width=6.31,height=3.96)
p2
dev.off()
...
pdf('results/GC-diagnosis-model/Figures/Model_performance/Model_performance_prediction_test_all_stage.pdf',width=9,height=6)
...
pdf('results/GC-diagnosis-model/Figures/Model-performance/PCA_External_test.pdf',width=6.31,height=3.96)
p2
dev.off()
df2<-df1%>%dplyr::select(PC1,PC2,state=state,sample_id)
...
pdf('results/GC-diagnosis-model/Figures/Model-performance/Model_performance_prediction_external_test_all_stage.pdf',width=9,height=6)
polt_model_performance_prediction_all_stage
dev.off()
